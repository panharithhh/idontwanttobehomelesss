...
Each part lives in its own folder.

## Course map

| # | Folder | Topic | Completed | Reference repo |
|---|--------|-------|-----------|----------------|
| 00 | [`00-micrograd/`](00-micrograd/) → **own repo** | Backprop & a scalar autograd engine | 2026-06-02 | [panharithhh/micrograd](https://github.com/panharithhh/micrograd) · [karpathy/micrograd](https://github.com/karpathy/micrograd) |
| 01 | [`01-makemore-bigram/`](01-makemore-bigram/) | Bigram counts + a 1-layer neural net | 2026-06-15 | [karpathy/makemore](https://github.com/karpathy/makemore) |
| 02 | [`02-makemore-mlp/`](02-makemore-mlp/) | MLP language model (Bengio 2003) | 2026-06-15 | [karpathy/makemore](https://github.com/karpathy/makemore) |
...
> Part **00 (micrograd)** lives in its own repo
